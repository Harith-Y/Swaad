...
COMMON_DISH_TASTE_PROFILES = {
    ...
    # American dishes
    "burger": [0.1, 0.7, 0.1, 0.0, 0.7, 0.1],
    "cheeseburger": [0.1, 0.7, 0.1, 0.0, 0.8, 0.1],
    "hamburger": [0.1, 0.7, 0.1, 0.0, 0.7, 0.1],
    "bacon burger": [0.1, 0.8, 0.1, 0.0, 0.8, 0.1],
    "fries": [0.1, 0.6, 0.0, 0.0, 0.3, 0.0],
    "french fries": [0.1, 0.6, 0.0, 0.0, 0.3, 0.0],
    "steak": [0.0, 0.6, 0.0, 0.0, 0.9, 0.1],
    "ribs": [0.3, 0.6, 0.1, 0.0, 0.8, 0.2],
    "bbq ribs": [0.4, 0.6, 0.1, 0.0, 0.8, 0.3],
    "wings": [0.1, 0.7, 0.1, 0.0, 0.6, 0.4],
    "chicken wings": [0.1, 0.7, 0.1, 0.0, 0.6, 0.4],
    "buffalo wings": [0.1, 0.7, 0.2, 0.0, 0.6, 0.8],
}
